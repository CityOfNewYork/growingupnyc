...
/* harmony default export */ __webpack_exports__["a"] = (function () {
  ...
  */
  $('button[type="submit"]').click(function (event) {
    event.preventDefault();
    var testForms = $(this).parent().parent().attr('class');
    var $form = $('.' + testForms);
