...
var toggleInput = function toggleInput(input, isActive) {
	input.setAttribute('value', isActive ? '0' : '1');
	return input;
};

var toggleButton = function toggleButton(button, isActive) {
	if (isActive) {
...
var attachBehavior = function attachBehavior(isCreatingFields) {
...
var init = function init(isCreatingFields) {
	return function () {
